...
export function HorarioEstudo() {
  ...
  const [horarioEstudo, setHorarioEstudo] = useState({
    horarioEstudoId: horarioEstudoMatutinoList.length + horarioEstudoVespertinoList.length + horarioEstudoNoturnoList.length + 1,
    horarioInicio: "",
    horarioFim: "",
    segunda: "",
    terca: "",
  ...
  async function salvarHorario() {
    setHorarioEstudo({ ...horarioEstudo, horarioEstudoId: horarioEstudo.horarioEstudoId + 1 });
  ...
  return (
    ...
    <div className="horario-estudo-container">
      ...
      <div className="horario-estudo-tabela-container">
        ...
        <div
          className={`horario-estudo-tabela-container ${acaoEstudoSelected === "Visualizar" ? "visualizar-mode" : ""
            }`}
        >
          {turnoEstudoSelected === "Matutino"
            ? horarioEstudoMatutinoList.map((el, index) => {
              return (
                <div
                ...
                >
                  <button
                    className={`anotacao-btn-deletar ${acaoEstudoSelected === "Editar"
                  ...
                  <div className="anotacoes-tabela-body-segunda">
                    <input
                      ...
                      onChange={(event) => {
                        let horarioAux = el
                        horarioAux.segunda = event.target.value
                        setHorarioEstudoMatutinoList([...horarioEstudoMatutinoList.filter(e => e.horarioEstudoId !== el.horarioEstudoId), horarioAux])
                        setHorarioEstudoMatutinoList([...horarioEstudoMatutinoList.sort((a, b) => a.horarioEstudoId - b.horarioEstudoId)])
                        console.log(horarioEstudoMatutinoList)
                      }
                      }
                    />
